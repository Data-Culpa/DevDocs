...
Backend:
 * Fix field presence monitoring to use normalized values which impacted customers with multiple data sessions per evaluation period.
 * Fixed an issue with type change alerting.
___
